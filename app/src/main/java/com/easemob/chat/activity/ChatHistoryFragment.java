...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.ease_fragment_conversation_history, container, false);
	}
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), R.layout.ease_row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
