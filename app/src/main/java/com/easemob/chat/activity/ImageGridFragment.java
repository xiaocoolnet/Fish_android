...
import cn.xiaocool.fish.BuildConfig;
import cn.xiaocool.fish.R;
import com.easemob.chat.domain.VideoEntity;
import com.easemob.chat.util.ImageCache;
import com.easemob.chat.util.ImageResizer;
import com.easemob.chat.util.Utils;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(R.layout.ease_choose_griditem, container,false);
