...
public class LoginActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ease_activity_login);
	...
	private void xlcd_login() {
		sharedPreferences = getSharedPreferences("user_do_info", Activity.MODE_PRIVATE);
		...
		new Thread() {
			public void run() {
				...
				handler.sendEmptyMessage(5);// 调用服务器登录函数
			}
		}.start();
	}
	...
	public void login(View view) {
		...
		sharedPreferences = getSharedPreferences("user_do_info", Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
