...
import com.easemob.chat.activity.ShowNormalFileActivity;
...
public class MessageAdapter extends BaseAdapter {
    ...
    private View createViewByMessage(EMMessage message, int position) {
        switch (message.getType()) {
            case LOCATION:
                return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.ease_row_received_location, null) : inflater.inflate(
                        R.layout.ease_row_sent_location, null);
            case IMAGE:
                return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.ease_row_received_picture, null) : inflater.inflate(
                        R.layout.ease_row_sent_picture, null);

            case VOICE:
                return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.ease_row_received_voice, null) : inflater.inflate(
                        R.layout.ease_row_sent_voice, null);
            case VIDEO:
                return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.ease_row_received_video, null) : inflater.inflate(
                        R.layout.ease_row_sent_video, null);
            case FILE:
                return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.ease_row_received_file, null) : inflater.inflate(
                        R.layout.ease_row_sent_file, null);
            default:
                // 语音通话
                if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false)) {
                    if (message.direct == EMMessage.Direct.RECEIVE) {
                        return inflater.inflate(R.layout.ease_row_received_voice_call, null);
                    } else {
                        return inflater.inflate(R.layout.ease_row_sent_voice_call, null);
                    }
                }
                // 视频通话
                else if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false)) {
                    if (message.direct == EMMessage.Direct.RECEIVE) {
                        return inflater.inflate(R.layout.ease_row_received_video_call, null);
                    } else {
                        return inflater.inflate(R.layout.ease_row_sent_video_call, null);
                    }

                } else if (((DemoHXSDKHelper) HXSDKHelper.getInstance()).isRobotMenuMessage(message)) {
                    if (message.direct == EMMessage.Direct.RECEIVE) {
                        return inflater.inflate(R.layout.ease_row_received_menu, null);
                    } else {
                        return inflater.inflate(R.layout.ease_row_sent_message, null);
                    }
                } else {
                    if (message.direct == EMMessage.Direct.RECEIVE) {
                        return inflater.inflate(R.layout.ease_row_received_message, null);
                    } else {
                        return inflater.inflate(R.layout.ease_row_sent_message, null);
                    }
                }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (message.getType() == EMMessage.Type.IMAGE) {
                ...
                if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_CALLBACK, false)) {
