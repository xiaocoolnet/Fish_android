...
public class HomeImagePagerAdapter extends BaseAdapter {
	...
	public HomeImagePagerAdapter(Context context, List<String> imageIdList,
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageOnFail(R.drawable.fisher_list_image) // 设置图片加载或解码过程中发生错误显示的图片
	...
	public HomeImagePagerAdapter setInfiniteLoop(boolean isInfiniteLoop) {
