...
import cn.xiaocool.fish.view.Indicator.FlowIndicator;

public class HomeViewFlow extends AdapterView<Adapter> {
	...
	public HomeViewFlow(Context context) {
		super(context);
		mSideBuffer = 3;
		init();
	}

	public HomeViewFlow(Context context, int sideBuffer) {
		super(context);
		mSideBuffer = sideBuffer;
		init();
	}

	public HomeViewFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray styledAttrs = context.obtainStyledAttributes(attrs,
				R.styleable.HomeViewFlow);
		mSideBuffer = styledAttrs.getInt(R.styleable.HomeViewFlow_sidebuffer, 3);
		init();
	}
