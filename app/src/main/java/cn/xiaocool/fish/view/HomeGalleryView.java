...
public class HomeGalleryView extends Gallery
{
	private Camera mCamera = new Camera();
	private int mMaxRotationAngle = 25;		// 最大旋转角度 60
	...
	public HomeGalleryView(Context context, AttributeSet attrs, int defStyle)
	{
